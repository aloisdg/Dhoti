...
function drawCircle(left: number, top: number, radius: number, color: string, backgroundColor: string) {
...
function draw(backgroundColor: string, columns: number, rows: number, radius: number, isEmpty: boolean) {
...
function drawBackground(color: string, width: number, height: number) {
  context.beginPath();
